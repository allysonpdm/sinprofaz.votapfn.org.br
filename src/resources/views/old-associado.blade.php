...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div
            class="absolute flex items-top justify-center alert alert-danger m-0"
            data-erro="votacao"
            role="alert"
            style="display:none;"
        >
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div id="principal" class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div id="associados-box" class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="/instrucoes" class="underline text-gray-900 dark:text-white">
                                        Instruções
                                    </a>
                                </div>
                            </div>
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="/resultados" class="underline text-gray-900 dark:text-white">
                                        Resultados
                                    </a>
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Confira sua(s) escolha(s) e confirme</h4>
                    </div>
                        <div class="modal-body">
                            ...
                            <input id="email" type="email" class="form-control" placeholder="E-mail" aria-describedby="emailHelp">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="confirmar" type="button" class="btn btn-success" data-dismiss="modal">
                            <span id="spinner-confirmar" class="spinner-border spinner-border-sm" style="display:none;"></span>
                            Confirmar
                        </button>
                    </div>
                </div>
