...
return [
    ...
    */
    ...
    'sufragio' => [
        'horario' => 'Horário de início da votação: :inicio, e termino da votação: :fim',
        'belongsTo' => 'A resposta não corresponde a questão.'
    ],

    'associado' => [
        'invalido' => 'Usuário não encontrado ou não autorizado',
    ],
    'cpf' => 'CPF inválido'
];
