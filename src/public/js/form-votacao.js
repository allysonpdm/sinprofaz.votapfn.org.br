...
let createVotacao = async ()=>{
    ...
    switch(response.status){
        case 200:
        case 201:
            window.location=`/votacao/${json.id}/arquivos`;
        break;
        case 422:
...
let createArquivo = async ()=>{
    ...
    switch(response.status){
        case 201:
            window.location=`/votacao/${json.sufragioId}/arquivos`;
        break;
        case 422:
            setErrors(json.errors);
        break;
...
let removerArquivo = async (id)=>{
    ...
    switch(response.status){
        case 200:
            window.location=`/votacao/${sufragioId}/arquivos`;
        break;
        case 422:
            setErrors(json.errors);
        break;
...
let createQuestao = async ()=>{
    ...
    switch(response.status){
        case 200:
        case 201:
            window.location=`/votacao/${json.sufragioId}/questoes/${json.id}`;
        break;
        case 422:
            setErrors(json.errors);
        break;
...
let createResposta = async ()=>{
    ...
    switch(response.status){
        case 200:
        case 201:
            window.location=`/votacao/${json.questao.sufragioId}/questoes/${json.questao.id}/respostas/${json.id}`;
        break;
        case 422:
            setErrors(json.errors);
        break;
    ...
    $('#list-questoes').DataTable({
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    window.location=`/votacao/${sufragioId}/questoes`
                },
        ...
        columns: [
            ...
            { title: 'Limite de escolhas', data: 'limiteEscolhas' },
            {
                ...
                render: ( data, type, row ) => {
                    return `
                        <a class="btn btn-primary col-6" href="/votacao/${data?.sufragioId}/questoes/${data?.id}">Editar</a>
                        <a class="btn btn-primary col-6" href="/votacao/${data?.sufragioId}/questoes/${data?.id}/respostas">Respostas</a>
                        `;
                }
            },
        ]
...
let listarRespostas = async ()=>{
    ...
    let repostas = await getRespostas(questaoId);
    ...
    $('#list-respostas').DataTable({
        ...
        buttons: [
            {
                ...
                className: 'btn-primary',
                action: function ( e, dt, node, config ) {
                    window.location=`/votacao/${sufragioId}/questoes/${questaoId}/respostas`
                },
                init: function(api, node, config) {
                    $(node).removeClass('btn-secondary')
                 }
        ...
        columns: [
            ...
            { title: 'Label', data: 'label' },
            {
                ...
                render: ( data, type, row ) => {
                    return `
                        <a class="btn btn-primary col-12" href="/votacao/${data?.questao.sufragioId}/questoes/${data?.questao.id}/respostas/${data?.id}">Editar</a>
                        `;
                }
            },
        ]
